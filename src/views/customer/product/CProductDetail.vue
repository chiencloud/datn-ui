    ...
    <div class="product-detail-content">
      ...
      <div class="product-detail-right">
        ...
        <div class="product-color">
          <div class="product-color-text"><b>{{product.level1name}}:</b> {{currentColorPick.color}}</div>
        ...
        <div class="product-size">
          <div class="product-size-title">{{product.level2name}}:</div>
        ...
        if (result && result.data) {
          ...
          if (onlineBranch) {
            ...
            ProductService.getPagingData({
              ...
              StoreProcedure: "Proc_GetPagingDataRelateProduct"
            }).then((result) => {
              if (result && result.data) {
