...
export default {
  ...
  data() {
    return {
      items: [
        {
          src: "https://360.com.vn/wp-content/uploads/2023/04/4-Anh-slide-web-Copy-2048x743.jpg",
        },
        {
          src: "https://360.com.vn/wp-content/uploads/2023/04/1350x490-Copy-1.jpg",
        },
        {
          src: "https://360.com.vn/wp-content/uploads/2023/04/4-Anh-slide-web-Copy-2048x743.jpg",
        },
      ...
      .then((result) => {
        if (
          ...
          ProductService.getPagingData({
            ...
            FilterFormula: "{0}",
            StoreProcedure: "Proc_GetListProductNewest"
          }).then((result) => {
